...
export const SAMPLE_STUDENT_DATA: NormalizedCertificateData = {
  ...
  subjects: [
    { name: `<div style="line-height: 1.2;"><span style="font-size: 1.15em; font-weight: 600;">English</span><br><span style="font-size: 0.85em; opacity: 0.8;">Languages (First Language)</span></div>`, score: "88", grade: "A", min: "33", max: "100", isced: "0232", category: "General" },
    { name: `<div style="line-height: 1.2;"><span style="font-size: 1.15em; font-weight: 600;">Mathematics</span><br><span style="font-size: 0.85em; opacity: 0.8;">Mathematics</span></div>`, score: "92", grade: "A+", min: "33", max: "100", isced: "0541", category: "General" },
    { name: `<div style="line-height: 1.2;"><span style="font-size: 1.15em; font-weight: 600;">Science</span><br><span style="font-size: 0.85em; opacity: 0.8;">Sciences</span></div>`, score: "85", grade: "A", min: "33", max: "100", isced: "0532", category: "General" },
    { name: `<div style="line-height: 1.2;"><span style="font-size: 1.15em; font-weight: 600;">History</span><br><span style="font-size: 0.85em; opacity: 0.8;">Humanities</span></div>`, score: "78", grade: "B", min: "33", max: "100", isced: "0222", category: "General" },
    { name: `<div style="line-height: 1.2;"><span style="font-size: 1.15em; font-weight: 600;">Geography</span><br><span style="font-size: 0.85em; opacity: 0.8;">Humanities</span></div>`, score: "81", grade: "A", min: "33", max: "100", isced: "0314", category: "General" },
    { name: `<div style="line-height: 1.2;"><span style="font-size: 1.15em; font-weight: 600;">Physical Education</span><br><span style="font-size: 0.85em; opacity: 0.8;">Physical Education</span></div>`, score: "95", grade: "A+", min: "33", max: "100", isced: "1014", category: "General" },
    { name: `<div style="line-height: 1.2;"><span style="font-size: 1.15em; font-weight: 600;">Computer Science</span><br><span style="font-size: 0.85em; opacity: 0.8;">Technology</span></div>`, score: "89", grade: "A", min: "33", max: "100", isced: "0611", category: "General" },
    { name: `<div style="line-height: 1.2;"><span style="font-size: 1.15em; font-weight: 600;">Art & Design</span><br><span style="font-size: 0.85em; opacity: 0.8;">Arts</span></div>`, score: "76", grade: "B", min: "33", max: "100", isced: "0211", category: "General" },
    { name: `<div style="line-height: 1.2;"><span style="font-size: 1.15em; font-weight: 600;">Music</span><br><span style="font-size: 0.85em; opacity: 0.8;">Arts</span></div>`, score: "84", grade: "A", min: "33", max: "100", isced: "0215", category: "General" },
    { name: `<div style="line-height: 1.2;"><span style="font-size: 1.15em; font-weight: 600;">Economics</span><br><span style="font-size: 0.85em; opacity: 0.8;">Business</span></div>`, score: "87", grade: "A", min: "33", max: "100", isced: "0311", category: "General" },
    { name: `<div style="line-height: 1.2;"><span style="font-size: 1.15em; font-weight: 600;">Foreign Language</span><br><span style="font-size: 0.85em; opacity: 0.8;">Languages (Second/Foreign)</span></div>`, score: "90", grade: "A+", min: "33", max: "100", isced: "0231", category: "General" },
  ],
  verification: {
